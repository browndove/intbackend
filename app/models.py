...
class SubmissionPatient(_SubmissionRowMixin, Base):
    ...
    bed_number: Mapped[str | None] = mapped_column(String(64))
    room_number: Mapped[str | None] = mapped_column(String(64))

    submission: Mapped["Submission"] = relationship(back_populates="patient_rows")


class AdminUser(Base):
    """Admin dashboard login accounts (bcrypt password hashes)."""
